...
public class Program {
    public static void main(String[] args) {
        ...
        Repository<VideoContent> pTchaikovsky = new Repository<>("pTchaikovsky");
        pTchaikovsky.add(new VideoContent("ПРОИЗВЕДЕНИЕ pTchaikovsky 1"));
        pTchaikovsky.add(new VideoContent("ПРОИЗВЕДЕНИЕ pTchaikovsky 2"));
