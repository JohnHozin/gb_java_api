...
import seminar.seminar_oop_5.views.Commands;
...
public class ViewUser {
    ...
    public void run() {
        seminar.seminar_oop_5.views.Commands com = seminar.seminar_oop_5.views.Commands.NONE;

        while (true) {
            try {
                String command = prompt("Введите команду: ");
                com = seminar.seminar_oop_5.views.Commands.valueOf(command.toUpperCase());
